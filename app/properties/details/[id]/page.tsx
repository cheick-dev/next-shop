			...
			<div className="container px-5 py-24 mx-auto">
				<div className="lg:w-4/5 mx-auto flex flex-wrap">
					<div className="lg:w-1/2 w-full lg:h-auto min-h-64 relative">
						...
						{currentImage < product.product_images.length - 1 && (
							<button
								className="text-2xl font-bold absolute top-1/2 right-0  transform  -translate-y-1/2 z-10 bg-black bg-opacity-50 text-white px-4 py-2 rounded-full flex items-center justify-center"
								onClick={() => changeImage(currentImage + 1)}
							>
								{">"}
							</button>
